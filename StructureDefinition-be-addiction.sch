...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'https://www.hl7belgium.org/fhir/StructureDefinition/be-ext-addiction-quantifier']) &lt;= 1">extension with URL = 'https://www.hl7belgium.org/fhir/StructureDefinition/be-ext-addiction-quantifier': maximum cardinality of 'extension' is 1</sch:assert>
