...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:performerType) &gt;= 1">performerType: minimum cardinality of 'performerType' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>ServiceRequest.extension.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>ServiceRequest.extension.value[x] 1</sch:title>
